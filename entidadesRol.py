...
class Empresa:
    def _init_(self, razonSocial, direccion, telefono, ruc):
...
class Departamento:
    def _init_(self, descripcion,id=1):
        self.__id = id
...
class Empleado(ABC): 
    def _init_(self,nombre,departamento,cargo, direccion, cedula, telefono, fechaIngreso, sueldo,id=1):
        self.__id = id
        self.nombre = nombre
...
class Administrativo(Empleado):
    def _init_(self,nombre,departamento,cargo, direccion, cedula, telefono, fechaIngreso, sueldo,id,comision= True):
        super()._init_(nombre,departamento,cargo, direccion, cedula, telefono, fechaIngreso, sueldo,id)
...
class Obrero(Empleado):
    def _init_(self,nombre,departamento,cargo, direccion, cedula, telefono, fechaIngreso, sueldo,id, cc= True):
        super()._init_(nombre,departamento,cargo, direccion, cedula, telefono, fechaIngreso, sueldo,id)
        self.cc = cc
...
class Deduccion:
    def _init_(self, iess, comision, antiguedad):
        self.__iess = iess    
    ...
    def getDeduccion(self):
        return  [str(self._iess),str(self.comision),str(self._antiguedad)]
     
class Prestamo:
    def _init_(self,empleado, aamm, valor, numPagos,saldo, estado= True,id=1):
        self.__id = id
...
class Sobretiempo:
    def _init_(self,empleado, aamm,hSuplementarias,hExtraordinarias,estado= True,id=1): 
        self.__id = id
        self.empleado=empleado
        self.aamm = aamm
